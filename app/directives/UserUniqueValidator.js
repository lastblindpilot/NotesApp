...
var UserUniqueValidator = UserUniqueValidator_1 = (function () {
    ...
    UserUniqueValidator.prototype.validate = function (c) {
        ...
        return new Promise(function (resolve) {
            return _this.http.get("checkUserUnique", { search: params })
                .map(function (response) { return response.json(); })
                .subscribe(function (res) { return res ? resolve(null) : resolve({ userUniqueValid: false }); });
        });
    };
    UserUniqueValidator.prototype.registerOnValidatorChange = function (fn) {
        return null;
    };
    ...
    core_1.Directive({
        ...
        providers: [
            { provide: forms_1.NG_ASYNC_VALIDATORS,
                useExisting: UserUniqueValidator_1,
                multi: true }
        ]
    }),
